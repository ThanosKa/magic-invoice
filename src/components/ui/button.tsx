  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer relative overflow-hidden",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-2 border-border bg-card dark:bg-card shadow-[0px_1px_2px_rgba(55,50,47,0.12)] dark:shadow-[0px_1px_2px_rgba(0,0,0,0.3)] hover:bg-accent hover:text-accent-foreground transition-all",
        secondary:
          "bg-secondary text-secondary-foreground border border-border shadow-[0px_1px_1px_rgba(55,50,47,0.08)] dark:shadow-[0px_1px_1px_rgba(0,0,0,0.2)] hover:bg-secondary/80 transition-all",
