...
export function InvoiceForm() {
  ...
  const steps: StepConfig[] = useMemo(
    () => [
      {
        id: "from-to",
        label: t("invoice.form.tabs.fromTo"),
        Component: PartyForm,
      },
      {
        id: "details",
        label: t("invoice.form.tabs.details"),
        Component: DetailsForm,
      },
      {
        id: "items",
        label: t("invoice.form.tabs.items"),
        Component: ItemsForm,
      },
      {
        id: "payment",
        label: t("invoice.form.tabs.payment"),
        Component: PaymentForm,
      },
      {
        id: "summary",
        label: t("invoice.form.tabs.summary"),
    ...
    <div className="border-b border-border">
      <div className="flex space-x-4 overflow-x-auto scrollbar-hide">
        {steps.map((step, index) => {
          ...
          const hasError =
            Object.keys(errors || {}).length > 0 && index <= activeStep;
          return (
            <button
              key={step.id}
